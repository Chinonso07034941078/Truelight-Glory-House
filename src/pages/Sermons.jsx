...
export default function SermonPage() {
  ...
  <div className="relative z-20 text-center text-white px-6 max-w-4xl">
    ...
    >
       Transformative Truth! New sermon up now!
    </motion.h1>
            ...
            >
              ...
              <div className="p-2">
                ...
                <a
                  ...
                  className="inline-block bg-blue-100 no-underline p-2 font-bold rounded-xl mt-2 text-xs text-blue-600 underline hover:text-yellow-500"
                >
                  Listen on Telegram
                </a>
              </div>
