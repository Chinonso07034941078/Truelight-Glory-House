    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-white">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl">
          ...
          <motion.h1
            className="text-4xl md:text-6xl lg:text-7xl font-light mb-8 leading-tight tracking-tight text-gray-900"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.4 }}
          >
            <span className="font-extralight">Get In</span>{' '}
            <span className="font-semibold bg-gradient-to-r from-gray-900 to-blue-700 bg-clip-text text-transparent">
              Touch
            </span>
            <br />
            <span className="text-2xl md:text-4xl lg:text-5xl font-light text-gray-600 block mt-2">
              We're here for you
            </span>
          </motion.h1>
          ...
          >
            <button
              ...
              className="bg-white/10 backdrop-blur-md text-gray-900 font-medium px-8 py-4 rounded-full border border-gray-200 hover:bg-white hover:shadow-md transition-all duration-500 transform hover:scale-105 flex items-center justify-center gap-3"
            >
            ...
            <button
              ...
              className="border-2 border-blue-600 text-blue-600 font-medium px-8 py-4 rounded-full hover:bg-blue-50 transition-all duration-300 flex items-center justify-center gap-3"
            >
      ...
      <section id="contact-info" className="py-20 md:py-32 relative overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-800 px-5 py-2 rounded-full font-medium mb-8 border border-blue-100">
              <MapPin className="w-4 h-4" />
              <span className="text-sm tracking-wider">Find Us Here</span>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <a
                  ...
                  className="group bg-white hover:bg-blue-50 p-8 rounded-xl transition-all duration-300 border border-gray-100 hover:border-blue-200"
                >
                  <PhoneCall className="w-10 h-10 text-blue-600 mb-4" />
                  <h4 className="text-lg font-medium mb-2">Call us now</h4>
                  <p className="text-gray-600 text-sm font-light mb-4">Speak directly with our team</p>
                  <div className="text-blue-600 font-medium">+234 813 045 6427</div>
                </a>
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm font-light mb-4">Send us a detailed message</p>
                  <div className="text-emerald-600 font-medium break-all">info.truelight9@gmail.com</div>
                </a>
                ...
                <button
                  ...
                  className="group bg-white hover:bg-blue-50 p-8 rounded-xl transition-all duration-300 border border-gray-100 hover:border-blue-200"
                >
                  <Send className="w-10 h-10 text-indigo-600 mb-4" />
                  <h4 className="text-lg font-medium mb-2">Contact form</h4>
                  <p className="text-gray-600 text-sm font-light mb-4">Fill out our online form</p>
                  <div className="text-indigo-600 font-medium">Send message →</div>
                </button>
              </div>
            </div>
          </div>
      ...
      <section id="contact-form" className="py-20 md:py-32 relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-6 tracking-tight">
              <span className="font-extralight">Send Us a</span>{' '}
              ...
              <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-8">
                {submitError && (
                  <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-red-700 mb-1">Submission failed</h4>
                      <p className="text-red-600 font-light">{submitError}</p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-4 bg-white border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 font-light ${
                          formValidation.name 
                      ...
                      />
                      {formValidation.name && (
                        <p className="text-red-500 text-sm font-light mt-2 flex items-center gap-2">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={6}
                      className={`w-full px-4 py-4 bg-white border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 font-light resize-none ${
